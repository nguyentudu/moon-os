...
- ../decision_memory_examples_v1.md
- ../query_proof/decision_query_answer_set_v1.md
- ../query_proof/decision_query_trace_matrix_v1.md
- ../query_proof/decision_memory_answer_template_v1.md

## Task

Answer the following questions using Decision Memory materials.
...
This task tests Decision Memory assisted context recovery only.

It does not prove a product feature or query engine.
